...
class LangBasedCompleter(Completer):
    ...
    def _handle_input_with_prefix(self, entire_input, word_to_be_completed):
        ...
        print("{}, input: {}, word: {}".format(self._parser.__class__.__name__, entire_input, word_to_be_completed))
        ...
        print("{}, last_token: {}".format(self._parser.__class__.__name__, last_token))
        print("{}, completion prefix: {}, word_to_be_completed: {}".format(self._parser.__class__.__name__, completion_prefix, word_to_be_completed))
        print("{}, expected_tokens: {}".format(self._parser.__class__.__name__, expected_tokens))
    ...
    def _evaluate_language(self, entire_input, word_to_be_completed):
        ...
        if token_position >= 0:
            ...
            print("{}, positions: [{}, {}]".format(self._parser.__class__.__name__, word_position, token_position))
